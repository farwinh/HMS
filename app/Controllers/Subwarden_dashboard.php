...
use App\Models\model_subwarden;
    ...
    class Subwarden_Dashboard extends BaseController
    {
        public function index()
        {
            echo view('SubWarden/dashboard/index.php');
        }
        ...
        public function model_click_update(){
            ...
            foreach(($result=$obj_warden->where('user_id',$user)->findAll()) as $d){
                $output .='
                <table border="0" style="color:black;"  class="table table-borderless table-light tbl ">
        ...
        public function chat(){
            echo view("SubWarden/Chat/chat.php");
        }
