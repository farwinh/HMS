<html>
    <head>
      ...
      <title>Experience-Subwarden</title>
    ...
    <?php
        ...
        <div class="container first_row" id="expArea" style="overflow:visible;padding-top:7%">
                ...
                <div class="exp" id="forme" type="button">
                        <span class="headingofdiv" >ADD NEW</span>
                        
                    </div>
                </div>
                <div class="col-md-6 bx" id="old">
                    <div class="exp" type="button" id="fromMe">
                ...
                <div class="row">
                  <div class="col-md-12 text-center">
                    <table  class="table tbldata" id="tblExp">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" style="width:20%">Attenches</th>
