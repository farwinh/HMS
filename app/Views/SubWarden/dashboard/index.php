<html>
    <head>
      ...
      <title>Dashboard-Subwarden</title>
    ...
    <script src="http://crypto-js.googlecode.com/svn/tags/3.0.2/build/rollups/md5.js"></script>
      ...
      .roomM{
        ...
        background-repeat:no-repeat;
          ...
          /*index page*/
          .activeTA{
            background-image: url('<?=base_url()?>/assets/images/Footer/dashA.svg');
            background-repeat:no-repeat;
          }
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <form method="post" action="<?php echo base_url('Subwarden_Dashboard/update_propic');?>" enctype="multipart/form-data">
                                    ...
                                    <img src="<?=base_url()?>/assets/images/Profiles/SubWarden/<?php echo $d['pro_pic']; ?>" onclick="triggerClick()" id="displayProfile" class="propic" >
