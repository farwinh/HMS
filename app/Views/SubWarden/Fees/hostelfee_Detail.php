      ...
      <div class="container " style="padding-top:5%;padding-left:5%">
        <div class="row">
          <div class="col-md-3 intro">
            <h3 class="myRoomHead">FEES</h3>
            <p>
              Welcome to hostel management system to manage hostel student fees
            </p>
          </div>
    ...
    <div class="modal fade " id="finecal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content mod">
          ...
          <div class="modal-body">
            <form method="post" id="form" autocomplete="off" action="<?php base_url(); ?>Warden_Fees_information/fine_info" target="blank">
              <div class="container">
