        ...
        <nav class="navbar navbar-custom navbar-expand-lg fixed-top" style="position:fixed;">
                  <div > 
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                       ...
                       <li class="nav-item">
                         <a class="nav-link nl active" href='<?php echo base_url(); ?>/'>HOSTEL FEES</a>
                       </li>
                       ...
                       <li class="nav-item">
                          ...
                          <div class="dropdown-menu proMenu" aria-labelledby="dropDownUser">
                                ...
                                <a class="dropdown-item " href='#'>EXPENCES</a>
       ...
       <div class="d-block d-sm-block d-md-none">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="row">
            ...
            <li class="nav-item">
              <a class="nav-link nl active" href='<?php echo base_url(); ?>/SubFees' style="color:white">HOSTEL FEES</a>
            </li>
...
<div class="container first_row" style="padding-top:2%;overflow:visible;">
                ...
                <div class="row" >
                  <div class="col-md-12 text-center">
                    <h2 class="h2">Hostel Fees </h2>
                  </div>   
                </div>
               
                <div class="row ">
                <div class="col-md-3 bx" id="fees_paid" onclick="functionFees(this.id)">
                    <div class="paid" id="fees_paid" type="button" data-toggle="modal" data-target="#paidModel" data-whatever="Paid" >
                        <span class="headingofdiv">Fees Paid Student Information</span>
                        
                    </div>
                </div>
                <div class="col-md-3 bx" id="not_paid" onclick="functionFees(this.id)">
                    <div class="unpaid"  id="not_paid" type="button" data-toggle="modal" data-target="#unpaidModal" data-whatever="Unpaid" >
                        <span class="headingofdiv">Fees Unpaid Student Information</span>
                        
                    </div>

                </div>
                <div class="col-md-3 bx" >
                    <div class="form1" id="fees_form" type="button" data-toggle="modal" data-target="#paidfees" data-whatever="Form">
                        <span class="headingofdiv">New form for paid student information</span>
                        
                    </div>
                </div>

                <div class="col-md-3 bx" id="fine_cal" >
                    <div class="fine" id="fine_cal" type="button" data-toggle="modal" data-target="#finecal" data-whatever="Fine">
...
<div class="modal fade " id="paidfees" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content mod">
      ...
      <div class="modal-body">
        <form method="post" id="form"  autocomplete="off" action="<?php base_url(); ?>Warden_Fees_information/fine_info" >
        <div class="container" >
