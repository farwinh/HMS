    ...
    <?php
        ...
        <nav class="navbar navbar-custom navbar-expand-lg fixed-top" style="position:fixed;">
          ...
          <div class="container " style="padding-top:5%;padding-left:5%">
            <div class="row" >
              ...
              <h3 class="myRoomHead">NOTICE MANAGEMENT</h3>
            <p>
        ...
        <script>
          ...
          function myFunctionEye() {
            ...
            <div class="container first_row" id="noticeDiv" style="padding-top:7%;overflow:visible;">
                       ...
                       <div class="row">
                          <div class="col-md-12"  id="msgsS">
                              ...
                              <textarea id="notice" name="msg" class="form-control" rows="7" placeholder="Type your notice..."></textarea>
                                <input type="file" id="myfile" name="myFile" class="form-control" style="margin-top:10px;">
                           </div>
                       </div>
                       <div class="row">
          ...
          <script>
              ...
              $('#postNotice').click(function(){
                ...
                var file=$('input[type=file]').val().replace(/C:\\fakepath\\/i, 'assets/images/Notice/Warden/');
