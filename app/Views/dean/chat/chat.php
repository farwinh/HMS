  ...
  <title>Chat-Dean</title>
    ...
    <?php
        ...
        function functionScrollMe(){
            //alert("s");
            var map = document.getElementById('chatDiv');
        ...
        <script>
          ...
          function myFunctionEye() {
            ...
            <div class="container first_row" id="chatDiv" style="padding-top:8%;overflow:visible;">
                ...
                <div class="col-md-3 bx" id="student">
                    <div class="student" type="button" data-toggle="modal" data-target="#studentModal" data-whatever="student">
