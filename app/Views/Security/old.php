                  ...
                  <div > 
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                        ...
                        <ul class="navbar-nav nt" >
                          ...
                          <div class="col">
                            <li class="nav-item">
                            <a class="nav-link nl" href="<?=base_url()?>/log_atte">STUDENT_ENTER_LOG</a>
                            </li>
                          </div>
                          <div class="col">
                            <li class="nav-item">
                            <a class="nav-link nl" href="<?=base_url()?>/chat_s">CHAT</a>
                            </li>
                          </div>
                          <div class="col">
                            <li class="nav-item">
                          ...
                          <img src="<?=base_url()?>/assets/images/Profiles/Security/<?php echo $d['pro_pic'];  ?>"" class="logoT">
                                                    </div>
        </nav>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <form method="post" action="<?php echo base_url('security_DashboardA/update_propic');?>" enctype="multipart/form-data">
                                
                                    <img src="<?=base_url()?>/assets/images/Profiles/Security/<?php echo $d['pro_pic']; ?>" onclick="triggerClick()" id="displayProfile" class="propic" style="width:75%;border-radius:50%;">
                            ...
                            $(document).ready(function(){
                              ...
                              $.ajax({
                                  url:"Security_DashboardA/get_details",
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <script>
                                            ...
                                            */
                                            ...
                                            //Newly added function
                                              function updateBTN(){
                                                ...
                                                var userID = <?php echo json_encode($us_id); ?>;
                                            $.ajax({
                                                  url:"security_DashboardA/model_click_update",
                                          ...
                                          $('#changePwd').click(function(){
                                                ...
                                                $.ajax({
                                                  url:"security_DashboardA/changePassword",
            ...
            <script>
              ...
              */
              $('#updateDet').click(function(){
                ...
                //alert(user);
                $.ajax({
                url:"security_DashboardA/update_user",
