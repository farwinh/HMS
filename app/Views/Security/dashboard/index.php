  ...
  ?>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="row" style="padding-top: 50px;">
              <ul class="navbar-nav nt">
                <li class="nav-item">
                  <a class="nav-link nl active" href='<?php echo base_url(); ?>/Security_login'>PROFILE</a>
                </li>
                <li class="nav-item">
    ...
    <script>
      ...
      window.onload = function() {
        ...
        $.ajax({
          url: "Security_Dashboard/getProPicOfMine",
          method: "POST",
          data: {
            user: user
          },
        ...
        $.ajax({
          url: "Security_Dashboard/getProPicOfMineForHeader",
          method: "POST",
          data: {
            user: user
          },
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-5">
                ...
                <form method="post" action="<?php echo base_url('Security_Dashboard/update_propic'); ?>" enctype="multipart/form-data">
              ...
              <div class="col-md-7">
                ...
                <script>
                  $(document).ready(function() {
                    ...
                    $.ajax({
                      url: "Security_Dashboard/get_details",
                    ...
                    <script>
                      ...
                      */
                      ...
                      function updateBTN() {
                        ...
                        var userID = <?php echo json_encode($us_id); ?>;
                        $.ajax({
                          url: "Security_Dashboard/model_click_update",
                      ...
                      $('#changePwd').click(function() {
                        ...
                        $.ajax({
                          url: "Security_Dashboard/changePassword",
      ...
      <script>
        ...
        */
        $('#updateDet').click(function() {
          ...
          //alert(user);
          $.ajax({
            url: "Security_Dashboard/update_user",
