...
<div class="container" style="  font-family:clip;
  ...
  <div class="form-group">  
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="number" class="form-control" id="room_no" placeholder="Enter Room Number" name="room_no" required>
      </div>
    </div>
    ...
    <div class="form-group">
      <!-- <label class="control-label col-sm-2" for="room_no">Room No:</label> -->
      <div class="col-sm-10">          
        <input type="number" class="form-control" id="floor_no" placeholder="Enter floor Number" name="floor_no" required>
      </div>
    </div>
