        ...
        <style>
           body{
            background:white;
             ...
             .headBG{
        background-image:url("<?=base_url()?>/assets/images/Header/medReq.svg");
      }
  ...
  box-shadow: 0 12px 16px 0 rgb(0, 102, 102),0 17px 50px 0 rgb(0, 179, 179);
    ...
    <?php
        ...
        <div class="container " style="padding-top:5%;padding-left:5%">
            ...
            <p>
              Welcome to hostel management system to manage medical requests
            </p>
              </div>
...
<div class="container" style="  font-family:clip;
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="number" class="form-control" id="room_no" placeholder="Enter Room No" name="room_no" required>
      </div>
    </div>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="number" class="form-control" id="contact" placeholder="Emergency Contact Number" name="contact">
      </div> 
      </div>  
    <div class="form-group">        
