...
<body>
  ...
  ?>
              ...
              <ul class="navbar-nav nt">
                ...
                <div class="col">
                  ...
                  <ul class="dropdown-menu mymenu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class="navbar-custom d"><a class="dropdown-item d active" href='<?php echo base_url(); ?>/stu_furniture_repair'>REPAIR</a></li>
      ...
      <div class="container " style="padding-top:5%;padding-left:5%">
        <div class="row">
          <div class="col-md-3 intro">
            <h3 class="myRoomHead">ROOM ITEMS</h3>
            <p>
    ...
    <div class="container" style="  font-family:clip;
      ...
      <h2 style="text-align:center;">ROOM ITEM REQUEST</h2>
      <form class="form-horizontal" method="POST" action="<?= base_url() ?>/Student_Furniture_request/furniture_req">
        ...
        <div class="form-group">
          ...
          <label>
            ...
            <img src="<?= base_url() ?>/assets/images/furniture/cupboard.webp" height="80px" width="80px">
          </label>
          &nbsp; &nbsp; &nbsp;
          <label>
          ...
          <label>
            ...
            <img src="<?= base_url() ?>/assets/images/furniture/bunk.png" height="80px" width="80px">
          </label>
          &nbsp; &nbsp; &nbsp;
          <label>
