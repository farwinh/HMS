...
<link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/css/Footer/style.css">
        ...
        <style>
             .headBG{
        background-image:url("<?=base_url()?>/assets/images/Header/reapair2.svg");
      }
      body{
        background:white;
      }
...
.button2:hover {
  box-shadow: 0 12px 16px 0 rgb(0, 102, 102),0 17px 50px 0 rgb(0, 179, 179);
    ...
    <?php
        ...
        <div class="container " style="padding-top:5%;padding-left:5%">
            <div class="row" >
              ...
              <h3 class="myRoomHead">FURNITURE</h3>
            <p>
   ...
   <br>   <div class="container" style="  font-family:clip;
         border:2px solid #f00;
         border-radius:15px;
         background-color:rgba(0,0,0,0.15);">
  <h2 style="text-align:center;">WOOD FURNITURE REQUEST</h2>
  <form class="form-horizontal"  method="POST" action="<?= base_url() ?>/Student_Furniture_request/furniture_req"  >
  <div class="form-group">
      <!-- <label class="control-label col-sm-2" for="reg_no">Registration No:</label> -->
      <div class="col-sm-10">          
        <input type="text" class="form-control"  placeholder="Enter Registration No" name="student_id">
      </div>
    </div>
   ...
   <div class="form-group">
     <h5>Furniture type</h5>
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="table" checked>
          <img src="<?=base_url()?>/assets/images/furniture/table.jpg" height="80px" width="80px" >
        </label>
		&nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="cupboard">
          <img src="<?=base_url()?>/assets/images/furniture/cupboard.jpg" height="80px" width="80px">
        </label>
		&nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="rack">
          <img src="<?=base_url()?>/assets/images/furniture/rack.jpg" height="80px" width="80px">
        </label>
		
		&nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="locker">
          <img src="<?=base_url()?>/assets/images/furniture/locker.jpg" height="80px" width="80px">
        </label>
		
        &nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="door">
          <img src="<?=base_url()?>/assets/images/furniture/door.jpg" height="80px" width="80px">
        </label>

        <br>
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="bulb">
          <img src="<?=base_url()?>/assets/images/furniture/bulb.jpg" height="80px" width="80px">
        </label>
        &nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="fan">
          <img src="<?=base_url()?>/assets/images/furniture/fan.jpg" height="80px" width="80px">
        </label>
        &nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="plug">
          <img src="<?=base_url()?>/assets/images/furniture/plug.jpg" height="80px" width="80px">
        </label>
      <br>
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="bunk">
          <img src="<?=base_url()?>/assets/images/furniture/bunk.jpg" height="80px" width="80px" >
        </label>
        &nbsp; &nbsp; &nbsp;
        <label>
          <input type="radio" id="furniture_type" name="furniture_type" value="metress">
          <img src="<?=base_url()?>/assets/images/furniture/metress.png" height="80px" width="80px">
        </label>
