          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="row" style="padding-top: 50px;">
              <ul class="navbar-nav nt">
                ...
                <div class="col">
                  <li class="nav-item">
                    <a class="nav-link nl active" href='<?php echo base_url(); ?>/notice'>NOTICES</a>
                  </li>
                </div>
                <div class="col">
                  <li class="nav-item">
      ...
      <div class="container " style="padding-top:5%;padding-left:5%">
        <div class="row">
          <div class="col-md-3 intro">
            <h3 class="myRoomHead">NOTICES</h3>
            <p class="myRoomHeadp">
              Welcome to hostel management system to manage the all notices
            </p>
          </div>
