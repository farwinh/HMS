                      ...
                      <div> 
                        ...
                        <a class="navbar-brand abrand" href="#"><img src="<?=base_url()?>/assets/images/Header/logo.png" class="proimg"></a>
                            ...
                            <ul class="navbar-nav nt" >
                              ...
                              <div class="col">
                                <li class="nav-item">
                                <a class="nav-link nl" href='<?php echo base_url(); ?>/notice'>NOTICES</a>                           </li>
                              </div>
                              <div class="col">
                                <li class="nav-item">
                                <a class="nav-link nl" href='<?php echo base_url(); ?>/gallery'>GALLERY</a>                  </li>
                              </div>
                              <div class="col">
                                <li class="nav-item">
...
<a href ="<?= base_url('delete_complaint/delete/'.$item['comp_id']) ?>" class="btn btn-danger btn-sm"> delete<i class='fas fa-trash-alt'></i></a>
